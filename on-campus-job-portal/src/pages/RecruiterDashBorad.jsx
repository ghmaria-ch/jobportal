...
// //           `http://localhost:5000/job/getrecruiterjobs/${recruiterId}`
// //         );
// //         setJobs(response.data);
// //         setFilteredJobs(response.data);
// //       } catch (error) {
...
// //       try {
// //         const response = await axios.get(
// //           `http://localhost:5000/application/getapplicantsforrecruiterjobs/`
// //         );
// //         setApplications(response.data.applicants);
// //       } catch (error) {
// //         console.error("Error fetching applications:", error);
...
// //     try {
// //       await axios.put(
// //         `http://localhost:5000/application/updateapplicationstatus/${applicationId}`,
// //         { status: action }
// //       );
// //       alert(`Application ${action} successfully!`);
// //       setApplications(
...
// //             Manage your job postings and applications seamlessly.
// //           </p>
// //         </div>
